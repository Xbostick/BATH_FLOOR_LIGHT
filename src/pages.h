...
<body>\n\
    ...
    <div id=\"menu-top\">\n\
        ...
        <a href=\"/LED=SWITCH\"><button class=\"round-button\" onclick=\"toggleButton(this)\">Кухня</button></a>\n\
        <a href=\"/LED=SWITCH\"><button class=\"round-button\" onclick=\"toggleButton(this)\">Спальня</button></a>\n\
    </div>\n\
\n\
...
\n\
            alert(\'Выбранный цвет: \' + selectedColor);\n\
            fetch('/', {\n\
                            method: 'GET', \n\
                            body: new FormData(),\n\
                            });\n\
